...
class Admin::EditionTagsControllerTest < ActionController::TestCase
  ...
  test 'should return an error on a version conflict' do
    ...
    put :update, params: { edition_id: @edition, edition_taxonomy_tag_form: { previous_version: 1, taxons: [child_taxon_content_id] } }
  ...
  test 'should post taxons to publishing-api' do
    ...
    put :update, params: { edition_id: @edition, edition_taxonomy_tag_form: { taxons: [child_taxon_content_id], previous_version: 1 } }
  ...
  test 'should post empty array to publishing api if no taxons are selected' do
    ...
    put :update, params: { edition_id: @edition, edition_taxonomy_tag_form: { previous_version: 1 } }
